...
public final class Constants {
    ...
    public static final String COIN_SYMBOL = "BFR";
    public static final String ACCOUNT_PREFIX = "BFR";
    public static final String PROJECT_NAME  = "BeFrank";
    ...
    public static final int MAX_ROLLBACK = Math.max(Nxt.getIntProperty("nxt.maxRollback"), 50);
    public static final int GUARANTEED_BALANCE_CONFIRMATIONS = isTestnet ? Nxt.getIntProperty("nxt.testnetGuaranteedBalanceConfirmations", 100) : 100;
    public static final int LEASING_DELAY = isTestnet ? Nxt.getIntProperty("nxt.testnetLeasingDelay", 100) : 100;
    ...
    public static final int MAX_ARBITRARY_MESSAGE_LENGTH = 200;
    public static final int MAX_ENCRYPTED_MESSAGE_LENGTH = 200 + 16;

    public static final int MAX_PRUNABLE_MESSAGE_LENGTH = 42 * 1024;
    public static final int MAX_PRUNABLE_ENCRYPTED_MESSAGE_LENGTH = 42 * 1024;

    public static final int MIN_PRUNABLE_LIFETIME = isTestnet ? 100 * 60 : 14 * 100 * 60;
    ...
    public static final long MAX_ASSET_QUANTITY_QNT = 1000000000L * 1000000000L;
    public static final int MIN_ASSET_NAME_LENGTH = 3;
    public static final int MAX_ASSET_NAME_LENGTH = 10;
    public static final int MAX_ASSET_DESCRIPTION_LENGTH = 1000;
    public static final int MAX_SINGLETON_ASSET_DESCRIPTION_LENGTH = 160;
    public static final int MAX_ASSET_TRANSFER_COMMENT_LENGTH = 1000;
    public static final int MAX_DIVIDEND_PAYMENT_ROLLBACK = 1001;
    ...
    public static final int MAX_CURRENCY_NAME_LENGTH = 12;
    public static final int MIN_CURRENCY_CODE_LENGTH = 3;
    public static final int MAX_CURRENCY_CODE_LENGTH = 6;
    public static final int MAX_CURRENCY_DESCRIPTION_LENGTH = 1000;
    public static final long MAX_CURRENCY_TOTAL_SUPPLY = 1000000000L * 1000000000L;
    ...
    public static final short MAX_SHUFFLING_REGISTRATION_PERIOD = (short)100 * 7;
    ...
    public static final int MAX_REFERENCED_TRANSACTION_TIMESPAN = 60 * 100 * 60;
